...
from fastapi_admin2.i18n import I18nService, I18nMiddleware
from fastapi_admin2.i18n import get_i18n, lazy_gettext, gettext
from fastapi_admin2.tests.conftest import DATA_DIR


@pytest.fixture(name="i18n")
def i18n_fixture() -> I18nService:
    return I18nService(path_to_default_translations=DATA_DIR / "locales")
...
class TestI18nCore:
    def test_init(self, i18n: I18nService):
    ...
    def test_use_locale(self, i18n: I18nService):
        assert i18n.current_locale == "en"
    ...
    def test_get_i18n(self, i18n: I18nService):
    ...
    def test_gettext(self, i18n: I18nService, locale: str, case: Dict[str, Any], result: str):
