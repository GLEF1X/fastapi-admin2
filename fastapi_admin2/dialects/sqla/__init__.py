...
from fastapi_admin2.dialects.sqla.dao.admin_dao import SqlalchemyAdminDao
from fastapi_admin2.dialects.sqla.markers import AsyncSessionDependencyMarker, SessionMakerDependencyMarker
from fastapi_admin2.dialects.sqla.models import SqlalchemyAdminModel
from fastapi_admin2.dialects.sqla.queriers import get_resource_list, delete_resource_by_id, \
...
class SQLAlchemyDialect:
    def __init__(self, engine: AsyncEngine, session_maker: sessionmaker,
                 admin_model_cls: Type[SqlalchemyAdminModel] = SqlalchemyAdminModel):
        self._engine = engine
